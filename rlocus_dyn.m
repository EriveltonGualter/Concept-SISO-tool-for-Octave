...
function [rldata_r, k_break, rlpol, gvec, real_ax_pts] = rlocus_dyn(sys, extents)
...
##    set (gcf,"visible","off");
    ...
    ax = gca ();
    set (gcf, "windowbuttondownfcn", {@down_fig, olpol, olzer});
    set (gcf, "windowbuttonmotionfcn", {@drag_fig, olpol, olzer});
    set (gcf, "windowbuttonupfcn", {@up_fig, olpol, olzer});
    set (ax, 'UserData', []);
...
function down_fig (hsrc, evt, olpol, olzer)
  down_fig =1;
...
function drag_fig (hsrc, evt, olpol, olzer)  

endfunction

function up_fig (hsrc, evt, olpol, olzer)
